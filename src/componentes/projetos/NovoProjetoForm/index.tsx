  ...
  return (
    <div className="w-full max-w-xl p-6 m-auto">
      ...
      >
        ...
        <label className={`mt-5 ${labelBase}`}>Imagem do Projeto</label>
        ...
        <label className={`mt-5 ${labelBase}`}>Tags (máx. 5)</label>

        <div className="mt-2 flex gap-2">
          <div className="flex w-full items-center gap-2 rounded-xl border border-white/10 bg-black/20 px-3 py-2 focus-within:border-white/20">
            <input
              value={tagInput}
        ...
        <div className="mt-6 flex items-center justify-end gap-2">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`rounded-xl border border-green-700 px-4 py-2 text-sm text-white transition ${
              loading
